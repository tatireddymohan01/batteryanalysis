...
class ModelEvaluator:
    ...
    def plot_residuals(
        ...
        axes[0].set_title(
            "Residuals vs Predicted Values", fontsize=12, fontweight="bold"
        )
    ...
    def plot_error_distribution(
        ...
        # Percentage errors
        axes[0, 1].hist(
            percentage_errors, bins=50, edgecolor="black", alpha=0.7, color="lightcoral"
        )
        axes[0, 1].set_xlabel("Percentage Error (%)", fontsize=11)
        axes[0, 1].set_ylabel("Frequency", fontsize=11)
        axes[0, 1].set_title(
            "Percentage Error Distribution", fontsize=11, fontweight="bold"
        )
        ...
        axes[1, 1].set_title(
            "Cumulative Error Distribution", fontsize=11, fontweight="bold"
        )
    ...
    def compare_models(
        self, results: Dict[str, Dict[str, float]], save_path: str = None
    ) -> None:
        """
...
def main():
    ...
    # Generate report
    evaluator.generate_evaluation_report(y_true, y_pred, model_name="Example Model")
